        ...
        >
          {filtered.map((p) => (
            <div
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.borderColor = `rgba(${hexRgb(A.blue)},0.3)`)
              }
              onMouseLeave={(e) =>
...
const CMDS: Record<string, () => string[]> = {
  help: () => [
    ...
    "  open <app>       — open About/Projects/Skills",
  ...
  return (
    <motion.div
      style={{
        ...
        boxShadow:
          "0 28px 70px rgba(0,0,0,0.65), 0 0 0 0.5px rgba(255,255,255,0.04)",
        overflow: "hidden",
      }}
      initial={{
        scale: 0.92,
        opacity: 0,
        y: state.maximized ? 0 : y.get() + 20,
      }}
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 13, fontWeight: 500, color: A.textMid }}>
            {def.title}
          </span>
        </div>
      </motion.div>
            ...
            <motion.button
              ...
              style={{
                ...
                boxShadow: app.isOpen
                  ? `0 0 16px rgba(${hexRgb(app.color)},0.22)`
                  : "none",
    ...
    return (
      <>
        ...
        >
          ...
          <h1
            style={{ margin: 0, fontSize: 22, fontWeight: 700, color: A.text }}
          >
            Best on Desktop
          </h1>
          <p
          ...
          >
            The 2026 portfolio is a macOS-inspired interactive desktop
            experience. Open it on a laptop or desktop for the full experience.
          </p>
          <div
            style={{
              display: "flex",
    ...
    <>
      ...
      >
        ...
        <main
          id="desktop"
          aria-label="Desktop"
          style={{ position: "absolute", inset: 0, top: 26 }}
        >
