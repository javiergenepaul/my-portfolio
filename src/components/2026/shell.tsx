...
const INIT_WINS: Record<WinId, WinState> = {
  ...
  services: { open: false, minimized: false, maximized: false, zIndex: 10 },
  languages: { open: false, minimized: false, maximized: false, zIndex: 10 },
...
export function Portfolio2026() {
  ...
  const WIN_ICONS: Record<WinId, React.ReactNode> = {
    ...
    languages: <LanguagesIcon size={13} />,
