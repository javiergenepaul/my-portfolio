      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            />
            <span style={{ color: "#FB7185", fontSize: 14 }}>
              Cebu, Philippines
            </span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ display: "flex", position: "relative" }}>
          <div
            style={{
              ...
              borderRadius: "50%",
              overflow: "hidden",
              border: "3px solid rgba(225,29,72,0.30)",
              boxShadow:
                "0 0 0 1px rgba(225,29,72,0.15), 0 0 60px rgba(225,29,72,0.18), 0 24px 60px rgba(0,0,0,0.6)",
            }}
          >
            <img
              src={profileSrc}
