...
const TITLE = "Gene Paul Mar Javier — 2027 Portfolio";
const DESCRIPTION =
  "Gene Paul Mar Javier's 2027 portfolio — coming soon. Full-Stack Engineer from Cebu, Philippines working with React, Next.js, Spring Boot, TypeScript, and Java.";
...
export default function Layout2027({
  children,
}: {
