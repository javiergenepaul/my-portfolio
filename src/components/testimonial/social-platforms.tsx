...
export const SOCIAL_PLATFORMS: SocialPlatform[] = [
  ...
  { value: "x", label: "X (Twitter)", icon: Twitter, placeholder: "https://x.com/…" },
  ...
  { value: "behance", label: "Behance", icon: Globe, placeholder: "https://behance.net/…" },
  { value: "dribbble", label: "Dribbble", icon: Dribbble, placeholder: "https://dribbble.com/…" },
