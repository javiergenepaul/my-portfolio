...
const describe = (name: string) =>
  `${name}'s 2026 portfolio features a macOS-inspired desktop experience built with React, Next.js, Spring Boot, TypeScript, and Java.`;
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const TITLE = `${profile.fullName} — 2026 Portfolio`;
  ...
  return {
    ...
    title: {
      default: TITLE,
      template: `%s | ${profile.fullName} 2026`,
    },
    ...
    icons: {
      icon: [
        ...
        { url: "/favicons/2026.svg", type: "image/svg+xml" },
      ],
...
export default async function Layout2026({
  children,
}: {
