...
export function Portfolio2026() {
  ...
  if (isMobile) {
    return (
      <>
        <LiveWallpaper />
        <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100dvh", padding: "32px 20px", textAlign: "center", gap: 16, fontFamily: MAC_FONT }}>
          ...
          <p style={{ margin: 0, fontSize: 14, color: A.textMid, maxWidth: 280, lineHeight: 1.7 }}>
            The 2026 portfolio is a macOS-inspired interactive desktop. Open it on a laptop or desktop for the full experience.
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 10, width: "100%", maxWidth: 260, marginTop: 8 }}>
            {[
              ...
              <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, background: A.glass, border: `1px solid ${A.glassBorder}`, borderRadius: 10, padding: "10px 14px", fontSize: 13, color: l.c, textDecoration: "none" }}>
                {l.icon} {l.label}
              </a>
            ))}
          </div>
