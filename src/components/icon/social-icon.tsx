...
export type SocialIcon = "github" | "linkedin" | "upwork";
...
export const SocialIcon = (props: SocialIconInterface) => {
      ...
      return (
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37256 18.6274 0 12 0C5.37256 0 0 5.37256 0 12C0 18.6274 5.37256 24 12 24ZM14.6152 13.4473C15.3196 14.0279 16.0942 14.3847 16.9207 14.3847C17.4583 14.3841 17.9734 14.1664 18.3535 13.7795C18.7336 13.3926 18.9478 12.8679 18.9487 12.3204C18.9482 11.7728 18.7346 11.2478 18.3545 10.8607C17.9744 10.4734 17.459 10.2557 16.9214 10.2554C15.429 10.2554 14.9475 11.7199 14.7922 12.5931L14.7861 12.6252L14.6152 13.4473ZM12.9382 11.5014C13.5383 9.42566 15.0166 8.16583 16.9207 8.16583C19.1707 8.16583 21 10.0292 21 12.3212C21 14.6116 19.1707 16.4849 16.9207 16.4849C15.8701 16.4849 14.9536 16.1564 14.1562 15.6376L13.2466 20H11.1487L12.4036 13.9851C11.8096 13.2272 11.3198 12.3701 10.9231 11.5244V12.4335C10.9231 14.6597 9.14551 16.4849 6.96069 16.4849C4.77759 16.4849 3 14.6597 3 12.4335V7H5.052V12.4335C5.05249 12.9492 5.25366 13.4438 5.61133 13.8087C5.96924 14.1736 6.45435 14.3791 6.96069 14.3801C7.46729 14.3793 7.95288 14.174 8.31079 13.809C8.66895 13.4441 8.87036 12.9495 8.87109 12.4335V7H10.9231C11.3271 8.41797 12.0232 10.1003 12.9382 11.5014Z"
          />
        </svg>
      );
