          ...
          <svg key={i} className="h-3 w-3" viewBox="0 0 24 24" aria-hidden>
            <defs>
              <linearGradient id={gid} x1="0" x2="1" y1="0" y2="0">
                <stop offset={`${fill * 100}%`} stopColor={accent} stopOpacity="1" />
                <stop offset={`${fill * 100}%`} stopColor={accent} stopOpacity="0.2" />
              </linearGradient>
            </defs>
            <path
  ...
  return (
    <div className="shrink-0 w-80 rounded-xl border border-border bg-card p-5 shadow-sm flex flex-col gap-3 mx-3 select-none">
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {(testimonial.github || testimonial.linkedin || testimonial.behance) && (
