// Personal info, social links, and portfolio data live in src/config/data/.
// They are re-exported through src/config/index.ts automatically.
...
export const ICEPS_SCHOOL_URL: string =
  "https://www.facebook.com/ICEPSOFFICIAL/";
