...
function AppearancePane() {
  ...
  const themes: {
    ...
    {
      id: "light",
      label: translate("settings.theme.mode.light"),
      icon: <Sun size={14} />,
      dark: false,
    },
    {
      id: "dark",
      label: translate("settings.theme.mode.dark"),
      icon: <Moon size={14} />,
      dark: true,
    },
    {
      id: "system",
      label: translate("settings.theme.mode.system"),
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: active
                    ? "color-mix(in srgb, var(--a26-teal) 6%, transparent)"
                    : "var(--a26-card)",
                }}
              >
                {t.dark === null ? (
                  <div className="w-full h-16 rounded-[7px] overflow-hidden mb-2 relative">
                    ...
                    >
                      <div
                        className="h-2.5"
                        style={{ background: "rgba(210,210,210,0.95)" }}
                      />
                    </div>
                    <div
...
function LanguagePane() {
  ...
  const LANGUAGES: {
    ...
    {
      code: "en",
      label: translate("sidebar.languageOption.english"),
      native: "English",
      flag: "🇺🇸",
    },
    {
      code: "ja",
      label: translate("sidebar.languageOption.japanese"),
      native: "日本語",
      flag: "🇯🇵",
    },
    {
      code: "fil",
      label: translate("sidebar.languageOption.tagalog"),
      native: "Filipino",
      flag: "🇵🇭",
    },
    {
      code: "ceb",
      label: translate("sidebar.languageOption.cebuano"),
      native: "Cebuano",
      flag: "🇵🇭",
    },
  ];
          ...
          {LANGUAGES.map((lang, i) => {
            ...
            return (
              ...
              >
                ...
                {active && (
                  <Check size={15} color="var(--a26-teal)" strokeWidth={2.5} />
                )}
              </button>
            );
          })}
...
function DateTimePane() {
  ...
  const now = new Date();
  const preview12 = now.toLocaleTimeString("en-US", {
    hour: "numeric",
    minute: "2-digit",
    hour12: true,
  });
  const preview24 = now.toLocaleTimeString("en-US", {
    hour: "2-digit",
    minute: "2-digit",
    hour12: false,
  });
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <div className="bg-a26-card border border-a26-card-border flex items-center rounded-xl p-4 gap-3.5">
          ...
          <div>
            <div className="text-a26-muted text-[11px] mb-0.75">
              {translate("win26.settings.previewDesc")}
            </div>
...
export function SettingsContent() {
  ...
  const PANES: { id: PaneId; label: string; icon: React.ReactNode }[] = [
    ...
    {
      id: "datetime",
      label: translate("win26.settings.dateTime"),
      icon: <Clock size={15} />,
    },
  ];
      ...
      <button
        ...
        style={{
          ...
          border: isMobile
            ...
            : "none",
          background: active
            ? "color-mix(in srgb, var(--a26-teal) 13%, transparent)"
            : "transparent",
